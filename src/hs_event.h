...
// things people say (PLAN-ARBITER.md). Until this landed, the only
...
//   own on this realm -- no separate presence gate is needed. World-scoped
...
// Deaths, all four of PLAN-ARBITER.md §5's death triggers off one hook.
...
// combat-state clause (PLAN-ARBITER.md §7 rule 1), so there is nothing the
...
// wipe/solo-death triggers already cover (PLAN-ARBITER.md §5).
...
// picks a side (PLAN-ARBITER.md §2).
