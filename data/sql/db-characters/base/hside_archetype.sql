...
CREATE TABLE IF NOT EXISTS `hside_archetype` (
  ...
  `spawn_weight`           SMALLINT UNSIGNED NOT NULL COMMENT 'out of 100 across all twelve rows',
  ...
  `min_level`              TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'UNUSED since review C1 (2026-09-03): the archetype draw no longer consults level',
  `max_level`              TINYINT UNSIGNED NOT NULL DEFAULT 255 COMMENT 'UNUSED since review C1 (2026-09-03): the archetype draw no longer consults level',
