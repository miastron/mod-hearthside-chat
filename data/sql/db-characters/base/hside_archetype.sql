...
VALUES
('RAIDER_SERIOUS',   'progression, parses, consumables; corrects others harshly, dismisses casuals, contemptuous',                               0.90, 0.40, 30, 4,  0, 0.0,  60,  255, 1),
('RAIDER_CASUAL',    'raid nights, wipes, loot, guild turnover/drama; cynical about officers, grumbles about teammates, never self-deprecating', 0.75, 0.50, 30, 5,  0, 0.0,  60,  255, 0),
('PVP_SERIOUS',      'rating, comps, matchups; contemptuous of bad players, condescending about skill, never doubts own skill',                  0.55, 0.55, 25, 4,  0, 0.0,  70,  255, 2),
('PVP_CASUAL',       'bgs, gearing up, light trash talk, winning; competitive edge, confident trash talk instead of self-doubt',                 0.35, 0.60, 25, 6,  0, 0.0,  10,  255, 1),
