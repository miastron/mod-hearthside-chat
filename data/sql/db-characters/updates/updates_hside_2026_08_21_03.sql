-- The opener system's fifth trigger: prolonged proximity at a shared quest
-- objective or flight master, built alongside the engagement-follow-up
-- feature since both share hs_engagement.cpp's periodic scan WorldScript.
-- New category plus a small hand-authored seed, same shape and tone as the
-- other four opener_* categories in base/hside_corpus_category.sql /
-- base/hside_corpus.sql.
